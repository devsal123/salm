...
const About = () => {
  return (
    <div className="overlay-area">
      <div id="about-area" className="">
        <div id="stories-row">
          <div id="about-pic">
            <img src="/img/try4.png" alt="Salifu Mutaru" />
            <div id="simple-info">
              <b>Salifu Mutaru</b>
              <p id="my-title">Developer</p>
              <div>
          ...
          <div id="my-info">
            <div id="info-content">
              ...
              <p>Each month, I work on a single project alongside my full-time job at Worldreader. We could be lucky working together this month.</p>
              <div>
